...
app = Celery('jsfinder', broker=os.environ['BROKER'], backend=os.environ['BACKEND'], )
...
def run(urls):
    ...
    os.system("cd {} && python3 _JSFinder.py -f {} -ou {}".format(FILEPATH,in_file_name,out_file_name))
